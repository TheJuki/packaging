...
libs="libjpeg libpng16 libXrender libfontconfig libfreetype libXext libX11 libxcb libXau libexpat libuuid libbz2 libbrotlicommon libgraphite2 libharfbuzz"
